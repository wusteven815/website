...
export default function ProjectCard({ children, devpost, github, name, noAnim }: ProjectCardProps) {
  ...
  return (
    <div
      className={`flex flex-col bg-stone-900 border border-stone-900 hover:border-neutral-500 rounded-xl p-6
        ...
        ${!noAnim && !isVisible && "motion-safe:opacity-0 motion-safe:translate-y-12"}`}
      ref={ref}
    >
